                    ...
                    <div class="bg-white py-3 px-4">
                        <div class="flex">
                            <div>
                                @if(!empty($Helper->postAvatar($trend->user_id)->name))
                                    <img src="{{asset("images/user/".$Helper->postAvatar($trend->user_id)->name)}}" class="h-10 rounded-full mr-3" alt="user image"/>
                                @else
                                    <img src='{{asset("images/avatar/avatar.png")}}' class="h-10 rounded-full mr-3" alt="thumb"/>
                                @endif
                            </div>
                        ...
                        <div class="shadow mb-6 pb-2">
                            @if(!empty($Helper->postImage($trend->id)->name))
                                <div class="my-2">
                                    <div>
                                        <img src="{{asset("images/post/".$Helper->postImage($trend->id)->name)}}" class="w-full">
                                    </div>
                                </div>
                        ...
                        <div class="action-center flex items-center justify-between px-4">
                            <div>
                                @if(Auth::user())
                                    <a href="{{url("post-like/".$trend->user_id.'/'.$trend->id)}}" class="flex items-center">
                        ...
                        @if(Auth::check())
                            <div class="comment-area flex items-center justify-between my-3">
                                <div class="w-1/6 lg:pl-10">
                                    <a href="#">
                                        @if(!empty($Helper->postAvatar($trend->user_id)->name))
                                            <img src="{{asset("images/user/".$Helper->postAvatar($trend->user_id)->name)}}" class="h-8 rounded-full mr-3" alt="user image"/>
                                        @else
