...
<a class="meta-author-avatar" itemprop="url" rel="author" href="">
    <img style="width:40px; height:40px; border-radius: 50%;" alt='avatar' src='{{asset("images/user/".$Helper->postAvatar($trend->user_id)->name)}}' 
...
<a href="https://www.facebook.com/sharer/sharer.php?u= " target="blank" title="Facebook" class="share share-facebook">
...
<a href="https://twitter.com/home?status= " target="blank" title="Twitter" class="share share-twitter">
<i class="fab fa-twitter"></i>
<span>Twitter</span>
</a>
</li>
<li class="li-share-pinterest">
<a href="https://pinterest.com/pin/create/button/?url= " target="blank" title="Pinterest" class="share share-pinterest">
<i class="fab fa-pinterest-p"></i>
<span>Pinterest</span>
</a>
</li>
<li class="li-share-linkedin">
<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url= " target="blank" title="Linkedin" class="share share-linkedin">
...
<a href="https://www.reddit.com/submit?url= " title="Reddit" class="share share-reddit">
...
<span class="image-element">
    <a href="{{ url('/post-full-view/'.$relatedpost->id.'/'.str_slug(strtolower($relatedpost->title), '-')) }}" class="post-link">
...
<a href="{{ url('/post-full-view/'.$relatedpost->id.'/'.str_slug(strtolower($relatedpost->title), '-')) }}" rel="bookmark">
...
<div class="entry-date meta-time machine-time time-short">
<time class="published" itemprop="datePublished" datetime="2018-04-23T00:00:00+00:00">{{date('d F \'y \a\t h:i:a', strtotime($relatedpost->created_at))}}</time>
<time class="updated" itemprop="dateModified" datetime="2019-10-03T02:46:58+00:00">{{date('d F \'y \a\t h:i:a', strtotime($relatedpost->updated_at))}}</time></div>
</div>
</div>
</div>
</div>
...
<span class="image-element">
<a href="{{ url('/post-full-view/'.$cat->id.'/'.str_slug(strtolower($cat->title), '-')) }}" class="post-link">
@if(!empty($cat->postimage->name))
<img width="480" height="384" src='{{ asset("images/post/".$cat->postimage->name)}}' class="attachment-thumbnail-medium size-thumbnail-medium" alt="" data-lazy="false" /><span class="height-element" style="padding-bottom:80%;"></span><span class="image-overlay"></span><span class="image-logo" style="width:40%"><img width="600" height="125" src="../wp-content/uploads/sites/23/2019/10/times-white.png" class="attachment-full size-full" alt="" srcset="https://fox.withemes.com/times/wp-content/uploads/sites/23/2019/10/times-white.png 600w, https://fox.withemes.com/times/wp-content/uploads/sites/23/2019/10/times-white-300x63.png 300w, https://fox.withemes.com/times/wp-content/uploads/sites/23/2019/10/times-white-60x13.png 60w, https://fox.withemes.com/times/wp-content/uploads/sites/23/2019/10/times-white-480x100.png 480w" sizes="(max-width: 600px) 100vw, 600px" />
@endif
</span></a></span></figure>
<div class="grid-body post-item-body">
<div class="post-item-header grid-header">
<h3 class="post-item-title wi-post-title fox-post-title post-header-section grid-title size-tiny" itemprop="headline">
<a href="{{ url('/post-full-view/'.$cat->id.'/'.str_slug(strtolower($cat->title), '-')) }}" rel="bookmark">
{{$cat->title}}
</a>
</h3></div>
</div>
