...
<center>
	<div style="width:600px; background:#fff; ">
		<h2 style="background:#0000CD; color:#FFF; height:38px; padding: 0 0 0 10px">You are Invited to Join Bido </h2>
		...
		<p style="text-align:justify; font-size:1.2em;">
			...
			<center><a href="http://www.bido.com.ng/register" title="click to Join"><button style="background:#0000FF; width:100px; height:30px;">JOIN</button> </a></center>
			<br/>
