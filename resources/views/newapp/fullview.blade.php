									...
									<div class="row">
										<div class="col-md-6">
											<div class="kf_commet_field">
												<input onclick="event.preventDefault();" placeholder="Your Name" name="name"  size="30" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="kf_commet_field">
												<input onclick="event.preventDefault();" placeholder="Your Email (optional)" name="email" type="text">
											</div>
										</div>
									
										<div class="col-md-12">
											<div class="kf_textara">
												<textarea onclick="event.preventDefault();" placeholder="Your Message" name="comment" required></textarea>
